...
import com.mapsa.exercise.seriesa.a.WarOfNumbers;
...
public class WarOfNumbersTest {
	...
	@Test
	public void test4() {
		assertEquals(228, WarOfNumbers
				.warOfNumbers(new int[] { 97, 83, 209, 141, 134, 298, 110, 207, 229, 275, 115, 64, 244, 278 }));
	}

	@Test
	public void test5() {
		assertEquals(83, WarOfNumbers.warOfNumbers(new int[] { 332, 92, 35, 315, 109, 168, 320, 230, 63, 323, 16, 204,
				105, 17, 226, 157, 245, 44, 223, 136, 93 }));
	}

	@Test
	public void test6() {
		assertEquals(846, WarOfNumbers.warOfNumbers(new int[] { 322, 89, 36, 310, 297, 157, 251, 55, 264, 244, 200, 304,
